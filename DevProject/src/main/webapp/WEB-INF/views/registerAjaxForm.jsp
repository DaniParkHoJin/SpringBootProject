...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#registerBtn07").on("click", function() {
			...
			let userIdVal = userId.val();
			let passwordVal = password.val();
			let userObject = {userId:userIdVal, password:passwordVal, address :	{postCode:"010908", location:"seoul"}};
		...
		$("#registerBtn08").on("click", function() {
			...
			let userObject = {userId : userIdVal, password : passwordVal, cardList : [{no:"23456", validMonth:"20190908"}, {no:"12342", validMonth:"20200705"}]};
